...
BTN_PALCE_BUY = InlineKeyboardButton('Купить', callback_data='buy')
BTN_DONE = InlineKeyboardButton('Закончить', callback_data='done')

SELL = InlineKeyboardMarkup().add(BTN_PLACE_SELL)
BUY = InlineKeyboardMarkup().add(BTN_PALCE_BUY)
HELP = InlineKeyboardMarkup().add(BTN_PLACE_SELL) # .add(BTN_PALCE_BUY)
